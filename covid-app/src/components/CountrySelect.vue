    ...
    async fetchCovidDataByDay() {
      try {
        ...
        data.forEach((item, i) => {
          ...
          //nisam bio siguran da li sam trebao da prikazem ukupan broj potvrdjenih slucajeva kao sto nudi api
          //ili koliko je bilo samo tog dana pa sam ostavio oba primjera
